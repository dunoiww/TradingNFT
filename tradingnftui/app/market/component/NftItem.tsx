...
export default function NftItem({ nft, onBuy, onDetail }: IProps) {
    ...
    return (
        <div className="flex items-center justify-center transition ease-in-out transform hover:-translate-y-1 duration-300">
            <div
                ...
                <button onClick={onDetail} className='mb-2'>
                    <img
                        src={nft.image}
                        ...
                        <div className="p-2 border border-gray-500 rounded-md">
                            <div className="flex flex-row justify-between items-center">
                                ...
                                <p className="text-sm font-semibold text-gray-500">
                                    {nft.price?.toLocaleString('en-US')} USDT
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <Button
                    disabled={wallet?.address === nft.author}
                    onClick={onBuy}
                    variant="contained"
